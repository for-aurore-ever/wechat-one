...
Page({
  ...
  async onLoad(options) {
    ...
    console.log(getSendWordStatus.rows)
    this.setData({
    ...
    console.log(this.data.gradeStudentList)
  },
  //点击完成学生信息的切换
  getStudentId(e){
    ...
    if(this.data.status==1){
      console.log(111)
      wx.navigateTo({
        url: '/pages/FacultyTeacher/SendWordok/SendWordok?studentId='+JSON.stringify(this.data.studentId)+'&stuName='+JSON.stringify(this.data.stuName)+'&sex='+JSON.stringify(this.data.sex)+'&avatar='+(this.data.avatar)
      })
    }else{
      wx.navigateTo({
        url: '/pages/FacultyTeacher/SendWord/SendWord?studentId='+JSON.stringify(this.data.studentId)+'&stuName='+JSON.stringify(this.data.stuName)+'&sex='+JSON.stringify(this.data.sex)+'&avatar='+(this.data.avatar)
      })
    }
