...
Page({
  ...
  goNext(){
    let growthKey=12
    wx.navigateTo({
      url: "/pages/ParentsStudents/myword/myword?studentId="+this.data.studentId+'&growthId='+this.data.growthId+'&growthKey='+growthKey
    })
  },
  goStart(){
    var that=this
    ...
    wx.chooseImage({
      ...
      success: function (res) {
        ...
        if(that.data.imgList.length>0){
          ...
          that.data.imgList[0]=res.tempFilePaths
        }
  ...
  onLoad:async function (options) {
    ...
    this.setData({
      ...
      growthKey:parseInt(options.growthKey),
